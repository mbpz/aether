...
This Code of Conduct applies within all community spaces — GitHub repositories
under `aether/`, Discord channels, mailing lists, and any other forum the
project uses. It also applies when an individual is officially representing the
community in public spaces (e.g., posting on social media under an official
account, or speaking at an event with prior arrangement).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers responsible for enforcement at
**conduct@aether.local**. All complaints will be reviewed and investigated
promptly and fairly.
